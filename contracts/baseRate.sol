...
contract BaseRate is ERC20Burnable, Operator {
    ...
    function setOracle(address _oracle) public onlyTaxOffice {
    ...
    function excludeAddress(address _address) public onlyTaxOffice returns (bool) {
        require(!excludedAddresses[_address], "address can't be excluded");
        excludedAddresses[_address] = true;
        return true;
    }

    function includeAddress(address _address) public onlyTaxOffice returns (bool) {
